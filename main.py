...
MAX_THREADS = min(int(os.environ.get("MAX_THREADS", "200")), 500)
...
def main():
    ...
    app.add_handler(CommandHandler("attack", attack_extreme))      # REPLACED
    app.add_handler(CommandHandler("nuke", nuke_cmd))              # NEW
    app.add_handler(CommandHandler("status", status_extreme))      # REPLACED
    app.add_handler(CommandHandler("stop", stop_extreme))          # REPLACED
