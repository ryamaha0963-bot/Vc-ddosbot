...
"""
        ...
        # Build clean professional box (no huge banner)
...
def main():
    try:
        ...
        app.add_handler(CommandHandler("deploy", binary_upload_start))  # direct deploy command
        ...
        logger.info("🚀 ARMADA NORMAL EDITION ONLINE")
